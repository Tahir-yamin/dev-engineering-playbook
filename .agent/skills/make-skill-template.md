...
|--------|---------|-------------|
| `make-skill-template_scripts_` | Executable code (Python, Bash, JS) | Automation that performs operations |
| `make-skill-template_references_` | Documentation agent reads | API references, schemas, guides |
| `make-skill-template_assets_` | Static files used AS-IS | Images, fonts, templates |
...
├── make-skill-template_scripts_
│   └── helper.py               # Executable automation
├── make-skill-template_references_
│   ├── api-reference.md        # Detailed docs
│   └── examples.md             # Usage examples
├── make-skill-template_assets_
