...
Use the template structure from [azure-deployment-preflight_references_REPORT-TEMPLATE.md](azure-deployment-preflight_references_REPORT-TEMPLATE.md).
...
See [azure-deployment-preflight_references_ERROR-HANDLING.md](azure-deployment-preflight_references_ERROR-HANDLING.md) for detailed error handling guidance.
...
- [Validation Commands Reference](azure-deployment-preflight_references_VALIDATION-COMMANDS.md)
- [Report Template](azure-deployment-preflight_references_REPORT-TEMPLATE.md)
- [Error Handling Guide](azure-deployment-preflight_references_ERROR-HANDLING.md)
