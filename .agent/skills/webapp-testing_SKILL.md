...
|--------|---------|-------|
| `webapp-testing_scripts_playwright_runner.py` | Basic browser test | `python webapp-testing_scripts_playwright_runner.py https://example.com` |
| | With screenshot | `python webapp-testing_scripts_playwright_runner.py <url> --screenshot` |
| | Accessibility check | `python webapp-testing_scripts_playwright_runner.py <url> --a11y` |
