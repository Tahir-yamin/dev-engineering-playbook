...
3. **Structure content**: Use appropriate template from [github-issues_references_templates.md](github-issues_references_templates.md)
...
Always use the templates in [github-issues_references_templates.md](github-issues_references_templates.md). Choose based on issue type:
