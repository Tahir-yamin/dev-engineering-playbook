...
# Working Days: 7 days/week (Implied by standard day calculation in Python, handled by Calendar in MSP)
...
tasks = [
    ...
    {"WBS": "1.2.1", "Task Name": "Item 1.001: Mobilization & Preparatory Works", "Duration": "10 days", "Predecessors": "1.1", "Outline Level": 3},
    {"WBS": "1.2.1.1", "Task Name": "Mobilization of Staff, Eqpt & Safety Hoarding (Item 1.001)", "Duration": "3 days", "Predecessors": "1.1", "Outline Level": 4},
    {"WBS": "1.2.1.2", "Task Name": "Dismantling Existing Structures/Pavers (Item 1.001)", "Duration": "7 days", "Predecessors": "1.2.1.1SS", "Outline Level": 4},
...
# Save to Excel
output_file = "d:/my-dev-knowledge-base/Project_Schedule_MSP_Export_v6.xlsx"
df.to_excel(output_file, index=False)
print(f"Schedule V6 exported to {output_file}")
