...
def resolve_preds(pred_str):
    ...
    # We will assume input uses semicolon or comma, let's normalize to semicolon first
    ...
    for p in preds:
        ...
        # Suffix can be SS, FF, SF, FS, +3 days, +3d, etc.
        # We need to clean up the suffix to be MS Project friendly (e.g., "SS+3d")
        ...
        if match:
            ...
            if potential_wbs in wbs_map:
                ...
                # Cleanup Suffix
                # Replace " days" with "d", remove spaces
...
# Save to Excel
output_file = "d:/my-dev-knowledge-base/Project_Schedule_MSP_Export_v5.xlsx"
df.to_excel(output_file, index=False)
print(f"Schedule V5 exported to {output_file}")
