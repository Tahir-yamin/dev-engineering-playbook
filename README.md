...
```
my-dev-knowledge-base/
├── workflows/          # 22 operational workflows for troubleshooting & development
├── skills/             # 6 skill path documents for learning & growth
├── agents/             # 13 AI agent configurations and instructions
├── guides/
│   ├── kubernetes/     # 2 K8s guides (kubectl, cheatsheets)
│   ├── docker/         # 1 Docker/Gordon AI guide
│   ├── authentication/ # 9 Better Auth implementation guides
│   ├── deployment/     # 1 Vercel/Railway deployment guide
│   └── security/       # 2 Security audit guides
├── walkthroughs/       # Project completion summaries & demo scripts
├── social/             # LinkedIn & Twitter post templates
├── CLAUDE.md           # Spec-driven development methodology
└── CONSTITUTION.md     # Project principles & decision framework
```
